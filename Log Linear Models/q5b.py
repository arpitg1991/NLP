...
'''
read feature and weigts of model
'''
...
def readDevFile(devFile):
	...
	'''
	iterate once over all sentences to get best tags for each
	'''
	...
	for ctr in range(0,totalSentences):
		...
		tagSequenceFinal = []
		'''
		write sequence of tags to output file
		'''
